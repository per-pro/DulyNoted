...
marx = Author.create!({ name: "Karl Marx", alive: false, birth_date: 1818, category: "revolutionary", created_at: 2022, updated_at: 2022, death_date: 1883, description: "Made the bourgeoisie pay for his carbuncles" })
