...
marx = Author.create({ name, alive, birth_date, category, created_at: 2022, updated_at: 2022, death_date, description })
lenin = Author.create({ name, alive, birth_date, category, created_at: 2022, updated_at: 2022, death_date, description })
freud = Author.create({ name, alive, birth_date, category, created_at: 2022, updated_at: 2022, death_date, description })
trotsky = Author.create({ name, alive, birth_date, category, created_at: 2022, updated_at: 2022, death_date, description })
